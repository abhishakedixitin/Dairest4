...
<html class="no-js" lang="en">
  ...
  <!-- error-area-start -->
    <div class="error">
		<a>
		  <img src= "img/cart/sadmumu.png" alt= "sad mumu face" class="sad">
		</a>
        <center><h4> Sorry!!! Username or password doesn't exist.</h4></center><br><br><br>
        <div class="products"> <center><h3><a href="m_sign-in.php" style="text-decoration:underline"">Click here to Sign In again </a></h3></center></div>
    </div><br><br>
    <!-- error-area-end -->
