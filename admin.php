...
<div class="x0" style="width:1300px; margin-top:0.000001px; padding:0.00001px">
    <div class="x2" style="width:700px; margin-left:200px;margin-right:100px">
        ...
        <h1 style=" text-align:center">Update User/Product Table</h1><br><br><br>

        <h2><a href="check_user_table.php" style="color:blue;margin-top:5%; font-size: 2vw;text-decoration: underline">Update
                User Table</a></h2>
        <br>
        ...
        <h2><a href="check_product_table.php"
               style="color:blue;margin-top:5%; font-size: 2vw;text-decoration: underline">Update Product Table</a></h2>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-5 col-sm-6 col-xs-12 mar_b-30">
                <div class="footer-wrapper">
                    ...
                    <p style="color:#ffffff">We devote to provide you the best shopping experience with sweets and
                        treats.</p><br>
...
<div>
    <center><p style="color:#ffffff;background-color:rgba(240,128,128,0.99)">DEVELOPED BY TEAM 16</p></center>
</div>
