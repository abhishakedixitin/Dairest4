										...
										<div class="product-content text-center">
											...
											<div class="product-icon">
												<ul>
													...
													<li>
												<a style="margin-left:80px;" class="item_add" href="addcart.php?mycart='.$row['p_id'].'&userid='.$id.'"><button class="button">Add to Cart</button></a>			
											</li>
