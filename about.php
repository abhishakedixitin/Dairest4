...
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
    ...
    <div class="x0" style="width:1300px;margin-top:-60px;">
      <div class="x2" style="width:2000px; margin-left:100px;margin-right:0.000001px">
          
    <br> <h3><center style="color:rgb(110,65,30)"> MUMU</center></h3> <br> 
           <h4 style="font-size: 140%">
Mumu is Dairest’s mascot and he is friendly, peppy, and sweet. Dairest’s little cow is the unofficial face of the company and appears in some places on their site. He emulates some of the core values of Dairest’s brand image. His bright blue eyes and cheerful attitude is welcoming and charming.Mumu captures the spirit of joy which a delicious sweet brings to people of all ages.</h4>

          <br><br>    <br>   <h3><center style="color:rgb(110,65,30)"> About US</center></h3> <br> 
<center> <h4 style="font-size: 140%">
1975: First full-time factory is opened to meet demand  <br> 

1999: Dairest opened its 50th store in New York City  <br> 

2005: Dairest was featured in an article candy brands  <br> 

2017: Dairest was awarded a Website of the Year Award 2017</h4></center>

            <br><br> <br>      <h3><center style="color:rgb(110,65,30)"> Founding </center></h3> <br> 

 <h4 style="font-size: 140%">Dairest was founded in 1967 by passionate candy enthusiasts, Margo Stephens and Ezekiel Fruit, who wanted to sell high-quality candy to consumers. They wanted to differentiate themselves with a different marketing proposition compared to their competitors. Going for aesthetically designed packaging instead of the bright colors differentiated their products. However, they did not find that selling through traditional retailers worked well for their brand and decided to start working on an ecommerce solution.

In 2010, Dairest founder Margo Stephens passed away and her daughter Tina Stephens took over. Tina Stephens is a graduate of the Art Institute program and, after going into massive amounts of debt, wanted to push Dairest further into the limelight to drive up sales. Several new lines of candies were added to the lineup in order to entice new customers.</h4>
