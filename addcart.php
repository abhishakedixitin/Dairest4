...
<!--order strored in database-->
	<div class="products">
		...
		$sql = "SELECT * FROM products WHERE p_id = $mycart";
			...
			echo '<span style="color:rgb(110,65,30);text-align:center;"><h1><center style="color:rgb(110,65,30)"> Product added to your cart successfully </center></h1></span>'; 
          echo '</div>
											<br><br>	<center><a class="item_add" font-size="30px" href="cart.php"><button class="button">Go to Cart</button></a></center>	
                                                 
															
											</div>';
			echo '<br><br><br><h1><center style="color:rgb(110,65,30)">Go Back To Category-> <a href="u_chocolate.php">Chocolate</a> / <a  href="u_lollipop.php">Lollipop</a> / <a  href="u_cake.php">Cake</a></center></h1>';
