...
<html class="no-js" lang="en">
 ...
 <!-- sign-in-area-start -->
   ...
   <div class="x0" style="width:110%;margin-left:-10%; margin-right:50%; padding:0.1%">
      <div class="x2" style="width:100%; margin-left:20%;margin-right:10%">
          
          <form action="m_link-Username.php" method="post" >
              
               <h4 style="text-align:center">Get your registered Username </h4><br><br>
      <h4 style="font-size: 15%vw">Registered Email Id:</h4>
          <input type="email" id="mail" name="user_email" style="border-color:rgb(110,65,30);border-width:thin" size="25" required><br>
