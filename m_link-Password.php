...
<div class="x0" style="width:130%; margin-top:0.1%; padding:1%; margin-left:5%;margin-right:0%"">
      <div class="x2" style="width:70%; margin-left:0%;margin-right:0%">
          ...
          <br>
          <center> <h4 style="font-size: 140%"> Submitted email Id sent to Admin. Kindly check email Id to get your registered password.</h4></center><br><br><br>
...
if (screen.width > 699) {
location.assign("link-Password.php")
}
