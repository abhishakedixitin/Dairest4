						...
						?></a>
                                    <ul>
                                        ...
                                        <li><a href="m_cart.php">My Cart</a></li>
                                              ...
                                              <li><a href="m_logout.php">Log Out</a></li>
										  </ul>
					</li>	
...
<br><br> 
 ...
 <!--start-content-->
        ...
        <div class="products">
            <div class="container" >
                <div class="products-grids"style="margin-left:5px;">
                        ...
                        <div class="col-md-5 grid-single">
                            <div class="flexslider">
                                <ul class="slides">
									...
									<div class="details-left-info simpleCart_shelfItem" style="margin-left:-10px;">
										<h4 style="margin-left:-3px;">'.$row['p_name'].'</h4>
										
										
										<div class="price_single">
										<span class="actual item_price"><h4 style="margin-left:70px;">$ '.$row['p_price'].'</h4></span>	
										</div>
									<br><br>	<h4 style="margin-left:-10px;" class="quick">Description:</h4>
										<p style="margin-left:-10px;"class="quick_desc" >'.$row['p_description'].'</p>
											<br>
											...
											<div class="quick-add-to-cart">
												...
												<a style="margin-left:50px;" class="item_add" href="addcart.php?mycart='.$row['p_id'].'&userid='.$id.'"><button class="button">Add to Cart</button></a>	
